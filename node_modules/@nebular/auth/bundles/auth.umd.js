(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('tslib'), require('@angular/common'), require('@angular/router'), require('@angular/forms'), require('@nebular/theme'), require('rxjs'), require('rxjs/operators'), require('@angular/common/http')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'tslib', '@angular/common', '@angular/router', '@angular/forms', '@nebular/theme', 'rxjs', 'rxjs/operators', '@angular/common/http'], factory) :
	(factory((global.nb = global.nb || {}, global.nb.auth = global.nb.auth || {}),global.ng.core,global.tslib,global.ng.common,global.ng.router,global.ng.forms,global.nb.theme,global.Rx,global.Rx.operators,global.ng.common.http));
}(this, (function (exports,_angular_core,tslib,_angular_common,_angular_router,_angular_forms,_nebular_theme,rxjs,rxjs_operators,_angular_common_http) { 'use strict';
...
var NbAuthTokenParceler = /** @class */ (function () {
    ...
    NbAuthTokenParceler = tslib.__decorate([
        _angular_core.Injectable(),
        tslib.__param(0, _angular_core.Inject(NB_AUTH_FALLBACK_TOKEN)),
        tslib.__param(1, _angular_core.Inject(NB_AUTH_TOKENS)),
...
var NbTokenLocalStorage = /** @class */ (function (_super) {
    ...
    NbTokenLocalStorage = tslib.__decorate([
        _angular_core.Injectable(),
        tslib.__metadata("design:paramtypes", [NbAuthTokenParceler])
    ], NbTokenLocalStorage);
...
var NbTokenService = /** @class */ (function () {
    ...
    NbTokenService = tslib.__decorate([
        _angular_core.Injectable(),
        tslib.__metadata("design:paramtypes", [NbTokenStorage])
    ], NbTokenService);
...
var NbAuthService = /** @class */ (function () {
    ...
    NbAuthService = tslib.__decorate([
        _angular_core.Injectable(),
        tslib.__param(1, _angular_core.Inject(NB_AUTH_STRATEGIES)),
        tslib.__metadata("design:paramtypes", [NbTokenService, Object])
    ], NbAuthService);
...
var NbDummyAuthStrategy = /** @class */ (function (_super) {
    ...
    NbDummyAuthStrategy = NbDummyAuthStrategy_1 = tslib.__decorate([
        _angular_core.Injectable()
    ], NbDummyAuthStrategy);
...
var NbOAuth2AuthStrategy = /** @class */ (function (_super) {
    ...
    NbOAuth2AuthStrategy = NbOAuth2AuthStrategy_1 = tslib.__decorate([
        _angular_core.Injectable(),
        tslib.__param(2, _angular_core.Inject(_nebular_theme.NB_WINDOW)),
        tslib.__metadata("design:paramtypes", [_angular_common_http.HttpClient,
...
var NbPasswordAuthStrategy = /** @class */ (function (_super) {
    ...
    NbPasswordAuthStrategy = NbPasswordAuthStrategy_1 = tslib.__decorate([
        _angular_core.Injectable(),
        tslib.__metadata("design:paramtypes", [_angular_common_http.HttpClient, _angular_router.ActivatedRoute])
...
var NbAuthComponent = /** @class */ (function () {
    ...
    NbAuthComponent = tslib.__decorate([
        ...
        tslib.__metadata("design:paramtypes", [NbAuthService, _angular_common.Location])
    ], NbAuthComponent);
...
var NbAuthBlockComponent = /** @class */ (function () {
    ...
    NbAuthBlockComponent = tslib.__decorate([
        _angular_core.Component({
...
var NbLoginComponent = /** @class */ (function () {
    ...
    NbLoginComponent = tslib.__decorate([
        _angular_core.Component({
            selector: 'nb-login',
        ...
        tslib.__param(1, _angular_core.Inject(NB_AUTH_OPTIONS)),
        tslib.__metadata("design:paramtypes", [NbAuthService, Object, _angular_core.ChangeDetectorRef,
...
var NbRegisterComponent = /** @class */ (function () {
    ...
    NbRegisterComponent = tslib.__decorate([
        _angular_core.Component({
...
var NbLogoutComponent = /** @class */ (function () {
    ...
    NbLogoutComponent = tslib.__decorate([
        _angular_core.Component({
            selector: 'nb-logout',
            template: "<div>Logging out, please wait...</div>\n"
        }),
        tslib.__param(1, _angular_core.Inject(NB_AUTH_OPTIONS)),
        tslib.__metadata("design:paramtypes", [NbAuthService, Object, _angular_router.Router])
    ], NbLogoutComponent);
...
var NbRequestPasswordComponent = /** @class */ (function () {
    ...
    NbRequestPasswordComponent = tslib.__decorate([
        _angular_core.Component({
...
var NbResetPasswordComponent = /** @class */ (function () {
    ...
    NbResetPasswordComponent = tslib.__decorate([
        _angular_core.Component({
...
var NbAuthModule = /** @class */ (function () {
    ...
    var NbAuthModule_1;
    NbAuthModule = NbAuthModule_1 = tslib.__decorate([
...
var NbAuthJWTInterceptor = /** @class */ (function () {
    ...
    NbAuthJWTInterceptor = tslib.__decorate([
        _angular_core.Injectable(),
        tslib.__param(1, _angular_core.Inject(NB_AUTH_TOKEN_INTERCEPTOR_FILTER)),
        tslib.__metadata("design:paramtypes", [_angular_core.Injector, Object])
...
var NbAuthSimpleInterceptor = /** @class */ (function () {
    ...
    NbAuthSimpleInterceptor = tslib.__decorate([
        _angular_core.Injectable(),
        tslib.__param(1, _angular_core.Inject(NB_AUTH_INTERCEPTOR_HEADER)),
        tslib.__metadata("design:paramtypes", [_angular_core.Injector, String])
